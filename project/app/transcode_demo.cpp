...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		using mm_pipeline::Transcoder;
		mm_pipeline::Transcoder transcoder{
			muxer, demuxer,
			{ videoDec, videoEnc, indices.video, videoTrack },
			{ audioDec, audioEnc, indices.audio, audioTrack }
		};
